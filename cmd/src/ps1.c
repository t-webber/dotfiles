...
static void pwd(char *const path) {
        char *pwd = exec("pwd");
        ...
        *end = '\0';
        ...
        SHORTE(path, pwd, "/", "/");
        SHORTE(path, pwd,
               "/arm/projectscratch/pd/pj1100048/tomweb01/popeye/genasm_mp/"
               "work-mardimatin",
               "w");
        SHORTE(path, pwd,
               "/arm/projectscratch/pd/pj1100048/tomweb01/popeye/genasm_mp",
               "g");
        SHORTE(path, pwd, "/arm/projectscratch/pd/pj1100048/tomweb01/popeye",
               "p");
