...
if os.getenv("DEVICE") == "v" then
	local venvPath = "/arm/projectscratch/pd/pj1100048/oyl_venvs/tomweb01/7a61a7cdec96e46a09535f21061ab5e300e3e5880c639935322889cf1559a37d"
	local venv = "x86_64_rhel8_python3.12.7"
		...
		settings = {
			python = {
				...
				analysis = {
					...
					extraPaths = {
						"/arm/tools/univent/univent-gcc12/2503.dev01/rhe8-x86_64/lib/python",
						"/arm/projectscratch/pd/pj1100048/tomweb01/armdir/popeye/tools",
					},
				},
			},
