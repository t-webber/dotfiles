...
local spec = {
        ...
        { 'topaxi/pipeline.nvim', build = 'make', cmd = 'Pipeline' },
        -----------
        --- Oil ---
        -----------
        {
                ...
                config = function()
                        ...
                        require('telescope').setup({
                                defaults = {
                                        ...
                                        prompt_prefix = '🔍',
                                        preview_title = false,
                                        preview = { timeout = 200, filesize_limit = 0.5 },
                                        hidden = true,
                                        cache_picker = {
                                                num_pickers = 1000,
                                        },
                ...
                config = function()
                        ...
                        require('conform').setup({
                                ...
                                formatters = {
                                        ...
                                        typstyle = {
                                                args = { '-l', '100', '-t', '4', '--wrap-text' },
                                        },
                                },
                        })
                        require('conform').formatters.shfmt = { append_args = { '-ln', 'bash' } }
                end,
                event = 'VeryLazy',
        },
        ------------------
