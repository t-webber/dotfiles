...
local truegreen = '#66cc33'
local truered = '#ff6600'

local function c(fg, bg, opts)
	return {
		fg = fg,
		bg = bg,
...
local colours = {
	...
	--         ["@constructor"] = c(red), !! already red by default :omg:
	...
	['@comment.warning'] = c(yellow), -- warning-type comments (e.g. WARNING, FIX, HACK)
	...
	---- Git Signs ---
	------------------
	GitSignsAdd = c(truegreen),
	GitSignsChange = c(yellow),
	GitSignsDelete = c(truered),
	...
	CustomStatusLineFilename = c(yellow),
	CustomStatusLineTime = c(magenta),
	CustomStatusLinePosition = c(yellow),
	...
	--> Symbols <-
	CustomStatusLineNormalSymbol = c(black),
	CustomStatusLineInsertSymbol = c(truegreen),
	...
	CustomStatusLineVisualSymbol = c(truered),
	CustomStatusLineVisualLineSymbol = c(truered),
	CustomStatusLineVisualBlockSymbol = c(truered),
	CustomStatusLineCommandSymbol = c(magenta),
	CustomStatusLineReplaceSymbol = c(cyan),
	CustomStatusLineTerminalSymbol = c(green),
	-- 	CustomStatusLineTerminalSymbol = c(yellow),

	--> Battery <--
	CustomStatusLineBatteryCharging = c(green),
	CustomStatusLineBatteryDischarging = c(red),
