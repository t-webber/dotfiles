...
vim.api.nvim_create_autocmd('FileType', {
        ...
        callback = function(args)
                ...
                if p == 'verilog' then p = 'systemverilog' end
...
local eol = vim.api.nvim_create_namespace('eol_sign')

vim.api.nvim_create_autocmd('CursorMoved', {
        callback = function()
                vim.api.nvim_buf_clear_namespace(0, eol, 0, -1)
                vim.api.nvim_buf_set_extmark(0, eol, vim.fn.line('.') - 1, 0, {
                        virt_text = { { '#', 'None' } },
